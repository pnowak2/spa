...
define(function(require) {
  var Backbone = require('backbone'),
    ...
    CeProjectPartnersPage = require('app/ce/components/project-partners-page/partners-map/main.component'),
    ceProjectPartnersPage = new CeProjectPartnersPage(module.config());
