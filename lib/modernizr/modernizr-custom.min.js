...
! function(e, n, t) {
  ...
  function c(e, n, s, o) {
    ...
    for (var d, c, m, h, v, g = ["modernizr", "tspan"]; !k.style;) d = !0, k.modElem = i(g.shift()), k.style = k.modElem.style;
    for (m = e.length, c = 0; m > c; c++)
      if (h = e[c], v = k.style[h], l(h, "-") && (h = u(h)), k.style[h] !== t) {
  ...
  Modernizr._q.unshift(function() {
    ...
    return e
  }), Modernizr.addTest("csstransitions", g("transition", "all", !0)), s(), o(y), delete w.addTest, delete w.addAsyncTest;
