    ...
    describe('Multiselect Collection', function() {
        ...
        describe('api', function() {
            ...
            describe('.hasMultipleSelections()', function() {
                it('should be defined', function() {
                    expect(MultiselectCollection.prototype.hasMultipleSelections).toEqual(jasmine.any(Function));
                });
                it('should return true if more than one item is selected', function() {
                  var country1 = new MultiselectModel({
                            id: 'pl',
                            selected: true
                        }),
                  ...
                  expect(collection.hasMultipleSelections()).toBe(true);
                });

                it('should return false if only one item is selected', function() {
                  var country1 = new MultiselectModel({
                            id: 'pl',
                            selected: true
                        }),
                  ...
                  expect(collection.hasMultipleSelections()).toBe(false);
                });

                it('should return false if there is no item selected', function() {
                  var country1 = new MultiselectModel({
                            id: 'pl',
                            selected: false
                        }),
