    ...
    describe('Multiselect Component', function() {
        ...
        describe('api', function() {
            ...
            describe('.hasMultipleSelections()', function() {
                it('should be defined', function() {
                    expect(MultiselectComponent.prototype.hasMultipleSelections).toEqual(jasmine.any(Function));
                });
                ...
                it('should delegate to view', function() {
                    ...
                    spyOn(MultiselectView.prototype, 'hasMultipleSelections').and.returnValue(fakeHasMultipleSelection);

                    expect(component.hasMultipleSelections()).toBe(fakeHasMultipleSelection);
                });
            });
