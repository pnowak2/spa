      ...
      describe('.render()', function() {
        ...
        describe('Project Description', function() {
          it('should contain project description', function() {
            expect(this.$el).toContainText('Project Description');
          });
        });

        describe('Project Start Year', function() {
        	it('should contain badge element', function() {
        		expect(this.$el).toContainElement('.vlr-project-item__badge.vlr-project-item__badge--start-year')
        	});

          it('should contain proper text', function() {
            expect(this.$el).toContainText('2012');
          });
        });
