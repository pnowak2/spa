    ...
    describe('api', function () {
      ...
      describe('.onSearchRequest()', function () {
        ...
        it('should toggle country explanation based on search criteria', function () {
          ...
          expect(this.view.toggleCountryExplanation).toHaveBeenCalledWith(fakeSearchCriteria);
        });
      });
      ...
      describe('.getMapContainer()', function () {
        ...
        it('should retrieve correct element', function () {
          spyOn($.prototype, 'find').and.callFake(function (selector) {
            if (selector === '.eplus-results-map__map-container') {
    ...
    describe('rendering', function () {
      describe('.render()', function () {
        ...
        it('should render current programme only disclaimer', function () {
          this.view.render();
          expect(this.view.$el).toContainElement('.eplus-results-map__current-programme-only-disclaimer');
        });

        it('should render map container', function () {
          this.view.render();
          expect(this.view.$el).toContainElement('.eplus-results-map__map-container');
        });

        it('should render results map component', function () {
          this.view.render();
          expect(this.view.$el.find('.eplus-results-map__map-container')).toContainHtml(this.view.mapComponent.render().view.$el.html());
        });
      });
    });
  });
