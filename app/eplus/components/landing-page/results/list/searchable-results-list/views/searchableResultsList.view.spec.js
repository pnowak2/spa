define(function(require) {
  ...
  describe('EPLUS Searchable Results List View', function() {
    ...
    describe('properties', function() {
      ...
      describe('.id', function() {
        it('should be defined', function() {
          expect(SearchableResultsListView.prototype.id).toEqual('eplus-searchable-results-list');
        });
      });

      describe('.className', function() {
        it('should be defined', function() {
          expect(SearchableResultsListView.prototype.className).toEqual('eplus-searchable-results-list');
        });
      });
    });
