    ...
    search: function(criteria) {
      return new RSVP.Promise(function(resolve, reject) {
        resolve(searchResultMapper.map({
          ...
          "took": "60 ms",
          "aaData": [
            ["workspace:\/\/SpacesStore\/40ef3df0-70fc-40e6-aea9-79769cc4c84d", "Arena World " + criteria.currentPage, "In a rift in time, between universes, exists a place where Gladiators from the known dimensions meet, to demonstrate their absolute skill in combat and survival against deadly foes enslaved from a...", "2013", "DK", "true"],
            ["workspace:\/\/SpacesStore\/9364c9e5-9ac9-4d26-95c5-d412ffbb222c", "Berlinale Co-Production Market " + criteria.currentPage, "The Berlinale Co-Production Market is the Berlin International Film Festival\u0092s service and networking platform for producers, financiers, broadcasters, distributors and sales agents working in int...", "2014", "DE|ES", "false"],
