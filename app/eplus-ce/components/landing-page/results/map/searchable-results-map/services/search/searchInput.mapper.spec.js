    ...
    describe('api', function() {
      describe('.map()', function() {
        ...
        describe('Clustering by country', function() {
          ...
          it('should contain country cluster property when zoom level is minimum + 1', function() {
            var input = {
              isMaxZoom: false,
              currentZoom: 3,
              minZoom: 2
          ...
          it('should not contain country cluster property if zoom level is bigger than minimum + 1', function() {
            var input = {
              isMaxZoom: false,
              currentZoom: 4,
              minZoom: 2
